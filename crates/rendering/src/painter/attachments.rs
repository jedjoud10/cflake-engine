...
use super::{PainterColorLayout, PainterDepthTexel, PainterStencilTexel, PainterBitmask};
...
pub trait Attachment<T: PainterBitmask> {
...
impl<'a, T: Texel + PainterBitmask> Attachment<T> for MipLevelMut<'a, Texture2D<T>> {
    fn untyped(&self) -> Option<UntypedAttachment> {
