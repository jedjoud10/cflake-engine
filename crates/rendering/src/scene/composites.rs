...
use crate::{canvas::{Canvas, ColorAttachment, DepthAttachment, FloatingPointColorAttachment}, buffer::UniformBuffer, prelude::{Uniforms, Shader}, mesh::Mesh, context::Context};
...
pub struct ClusteredShading {
    ...
    pub(crate) color: Handle<FloatingPointColorAttachment>,
