...
pub trait TextureAllocator {
    ...
    unsafe fn alloc_immutable_storage(name: u32, extent: <Self::TexelRegion as Region>::E, levels: u8, ptr: *const c_void);
    ...
    unsafe fn alloc_resizable_storage(name: u32, extent: <Self::TexelRegion as Region>::E, unique_level: u8, ptr: *const c_void);
