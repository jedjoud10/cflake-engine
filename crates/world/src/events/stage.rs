...
pub fn user(system: &mut System) {
    ...
    system.insert_device(|world: &mut World, device: &DeviceEvent| {});
    system.insert_window(|world: &mut World, window: &mut WindowEvent| {});
}
