...
pub(crate) fn quat_to_rot(quat: vek::Quaternion<f32>) -> rapier3d::na::UnitQuaternion<f32> {
    rapier3d::na::UnitQuaternion::<f32>::from_quaternion(rapier3d::na::Quaternion::new(
        quat.w, quat.x, quat.y, quat.z,
    ))
}

// Convert an isometry into a translation and rotation
pub(crate) fn isometry_to_trans_rot(
    isometry: &rapier3d::na::Isometry3<f32>,
) -> (vek::Vec3<f32>, vek::Quaternion<f32>) {
...
pub(crate) fn trans_rot_to_isometry(
    vec: vek::Vec3<f32>,
    quat: vek::Quaternion<f32>,
) -> rapier3d::na::Isometry3<f32> {
