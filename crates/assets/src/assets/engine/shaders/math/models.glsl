...
vec3 brdf(
	...
	brdf += calculate_sky_color(-reflect(camera.view, surface.normal), -light.backward) * fresnelRoughness(surface.f0, camera.view, surface.normal, surface.roughness) * 1.60;
	return brdf;
}