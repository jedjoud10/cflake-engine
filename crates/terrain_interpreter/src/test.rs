...
#[cfg(test)]
mod test {
    use crate::{Interpreter, NodeInterpreter, error::InterpreterError, nodes::{base_position::BasePosition, comparator::Comparator, density_operations::DensityOperationType, selector::Selector, snoise::SNoise, splitter::Splitter}};
