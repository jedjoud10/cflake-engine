...
impl Graphics {
    ...
    pub(crate) unsafe fn new(
        ...
        let graphics_family_index = super::pick_queue_family(
            &queue_families,
            &surface_loader,
            physical_device,
            surface,
        ...
        let present_family_index = super::pick_queue_family(
            &queue_families,
            &surface_loader,
            physical_device,
            surface,
        ...
        let present = super::pick_presentation_mode(
            &surface_loader,
            physical_device,
            surface,
            window_settings,
        ...
        let swapchain_create_info =
            super::create_swapchain_create_info(
                surface, format, extent, present,
            );
    ...
    pub(crate) unsafe fn draw(&mut self, value: f32) {
        if let Some(swapchain) = &mut self.swapchain {
            ...
            clear_color_value.float32 = [value; 4];
    ...
    pub(crate) unsafe fn destroy(mut self) {
        ...
        self.device
            .destroy_fence(swapchain.rendering_finished_fence, None);
